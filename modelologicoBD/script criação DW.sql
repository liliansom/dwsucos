...
ALTER TABLE Dim_Cliente COMMENT 'Tabela de Dimensão cliente';
...
CREATE TABLE Fato_002 (
                ...
                PRIMARY KEY (Cod_Fabrica, Cod_Cliente, Cod_Produto, Cod_Tempo)
);
...
CREATE TABLE Fato_001 (
                ...
                PRIMARY KEY (Cod_Fabrica, Cod_Cliente, Cod_Tempo, Cod_Organizacional, Cod_Produto)
);
